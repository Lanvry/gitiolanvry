            ...
            <div class="row">
                <div class="col-md-4 col-xs-12">
                    ...
                    <div class="alamat">
                        ...
                        <p><i class="fa-solid fa-globe"></i><a href="https://arjunapersonal.rf.gd/">
                                arjunapersonal.rf.gd/</a></p>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-xs-12 hidden-sm hidden-xs">
                    <center><span class="" id="copyright">Created By Arjuna Lanang Adiwarsana</span></center>
                </div>
                <div class="col-md-12 col-xs-12 hidden-md hidden-lg">
                    <center>
                        <p style="margin:unset; color:#fff">Created By Arjuna Lanang Adiwarsana</p>
                    </center>
                </div>
            </div>
        </div>
...
<script>
    ...
    $(() => {
        ...
        $("#toolbar-p-1-container").removeClass("bg-blur");
        ...
        $("#main-content").scroll(function(e) {
            ...
            if (scrollTop > 300) {
                ...
                $("#toolbar-p-1-container").addClass("bg-blur");
