<head>
  ...
  <link rel="stylesheet" href="css/fe/bootstrap.min.css" type="text/css" />
  <link rel="stylesheet" href="css/fe/style1.css">
  <link rel="stylesheet" href="css/fe/portal.css" type="text/css" />
  <link rel="stylesheet" href="bakesbangpol.css" type="text/css" />
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css" />
  <link rel="stylesheet" type="text/css" href="css/fe/table1.min.css">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" />
  <link href="css/fe/slick.css" rel="stylesheet" type="text/css" />
  <link href="css/fe/slick-theme.css" rel="stylesheet" type="text/css" />
  <link href="css/fe/owl.carousel.css" rel="stylesheet" type="text/css" />
  <link href="css/fe/select2.css" rel="stylesheet" type="text/css" />
  <script src="js/fe/jquery.min.js" type="text/javascript"></script>
  <script src="js/fe/jquery-2.2.3.min.js"></script>
  <script src="https://unpkg.com/aos@2.3.1/dist/aos.js"></script>
  <script src="js/fe/owl.carousel.min.js"></script>
  <script src="js/fe/select2.min.js"></script>
</head>
<!-- link -->
...
<div id="navbar_based_modal" class="must-close mobile-offcanvas ">
  <div id="navbar_based_modal_inner" class="container-fluid mobile-offcanvas-inner scroller">
    <div class="offcanvas-header">
      <button class="btn float-right btn-close"><i class="fas fa-times"></i> </button>
      <a class="navbar-brand" href="">
        <div style="display: flex; flex-direction:row;">
...
<div id="ctn-utama" class="based-div-1">
  ...
  <div id="main-content" style="opacity: 1; z-index:1; position: relative; max-height:100vh; overflow-y:auto; overflow-x:hidden;" class="scroller">
    <div id="p-1" style="max-width:100vw !important; height:100vh; overflow-x:hidden;">
      <div style="min-height: 5vh"></div>
      <div id="bwi-brand" class=" title-text-single coloring-text-logo typewriter">
      ...
      <div style="text-align: center">
        <button type="button" class="btn">
          <a class="blink_me" style="margin:auto; color:#ffffff; font-size:2rem;" id="btn-jelajah" href="" onclick="document.getElementById('p-2').scrollIntoView({'behavior': 'smooth'});return false;">
            <i style="color: #999 !important;font-size: 40px;" class="fas fa-chevron-down"></i>
          </a>
        </button>
      </div>
      <div style="min-height: 10vh"></div>
    </div>
    <div id="p-2" class="" style="scroll-behavior: smooth; min-height: 100vh; padding-top:50px;background: #fff;">
      <div id="p-2-inner">
        ...
        <script>
          function kontak() {
            $('#main-content').animate({
              scrollTop: $('#kontakkami').offset().top
            }, 1000);
          }
        ...
        <a href="#" id="toTop"></a>
        <!-- JAVASCRIPT FILES -->
        <script type="text/javascript" src="js/fe/bootstrap.bundle.min.js"></script>
        <script src="js/fe/slick.min.js"></script>
        <script>
        ...
        <!--<div id="contact"></div>-->
        <script src="js/fe/jquery.smartmenus.min.js"></script>
