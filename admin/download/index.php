...
<body>
    ...
    <section>
        ...
        <hr>
        <div class="card">
            <form action="sistemadd.php" enctype="multipart/form-data" method="post">
                <label for="" class="label-control">Tambahkan Download</label>
                <div class="row">
                    <div class="col">
                        <input type="text" class='form-control' name="dokumen" style="margin-bottom: 10px;" placeholder="Nama Dokumen">
                    </div>
                    <div class="col">
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_array($mysql)) {
                        echo "
                             ...
                             <td style='position:relative;'> <a style='position:absolute;top:-10px;right:10px;' href='deletesistem.php?id_dokumen=" . $row["id_dokumen"] . "'><button class='removebtn-position-relative'><ion-icon name='trash'></ion-icon></button></a> </td>
                             </tr>
                           ";
                    }
