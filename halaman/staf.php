...
<head>
    ...
    <style>
        ...
        .card:hover {
            box-shadow: 1px 5px 10px rgba(0, 0, 0, 0.116);
        }
                ...
                <article class="article-justify container">
                    ...
                    <div class="judul">
                        <div class="judulbackground">
                            <h3><b>Staff & Kepemimpinan</b></h3>
                            <div class="kotak"></div>
                        </div>
                    </div>
                    <br><br><br><br><br><br>
                    <center>
                        <h1><b>Kepala Badan</b></h1>
                        <hr><br>
                    </center>
                    <div class="grid posisi-1">
                        <center>
                            <div class="card" style="transform: scale(1.1);">
                                <img src="https://lanvry.github.io/gitiolanvry/icon.png" alt="">
                                <div class="cardcontent">
                                    <h2><b>Arif Firmanto</b></h2>
                                    <p>Plt Kepala Badan</p>
                                </div>
                            </div>
                        </center>
                    </div><br><br>
                    <center>
                        <h1><b>Struktur A</b></h1>
                        <hr>
                    </center>
                    <div class="grid posisi-2a">
                        <center>
                            <div class="card">
                                <img src="https://lanvry.github.io/gitiolanvry/icon.png" alt="">
                                <div class="cardcontent">
                    ...
                    <center>
                        <h1><b>Struktur B</b></h1>
                        <hr>
                    </center>
                    <center>
                        <div class="grid posisi-3a">
                            <div class="card">
                                <img src="https://lanvry.github.io/gitiolanvry/icon.png" alt="">
                                <div class="cardcontent">
                                    <h2><b>Arif Firmanto</b></h2>
                        ...
                        <center>
                            <h1><b>Struktur C</b></h1>
                            <hr>
                        </center>
                        <center>
                            <div class="grid posisi-4a">
                                <div class="card-4a" style="transform: scale();">
                                    <img src="https://lanvry.github.io/gitiolanvry/icon.png" alt="">
                                    <div class="card-4acontent">
                                        <h2><b>Arif Firmanto</b></h2>
                                        <p>Plt Kepala Badan</p>
                                    </div>
                                </div>
                                <div class="card-4a" style="transform: scale(1);">
                                    <img src="https://lanvry.github.io/gitiolanvry/icon.png" alt="">
                                    <div class="card-4acontent">
                                        <h2><b>Arif Firmanto</b></h2>
                                        <p>Plt Kepala Badan</p>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-4 col-xs-12">
                                ...
                                <div class="alamat">
                                    <p><i class="fa-solid fa-location-dot"></i> Jl. Trunojoyo no. 141 Kolor Kab. Sumenep
                                    </p>
